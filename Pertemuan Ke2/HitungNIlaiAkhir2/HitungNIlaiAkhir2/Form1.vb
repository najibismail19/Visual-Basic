Public Class Form1
    ...
    Private Sub TxtAbsensi_TextChanged(sender As Object, e As EventArgs) Handles TxtAbsensi.TextChanged

    End Sub

    Private Sub txtHasilAbs_TextChanged(sender As Object, e As EventArgs) Handles txtHasilAbs.TextChanged
